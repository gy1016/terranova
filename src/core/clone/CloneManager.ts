    ...
    if (sourceItem instanceof Object) {
      ...
      switch (itemType) {
        ...
        case Float64Array:
          ...
          const targetTypeArrayItem = <TypeArray>target[k];
        ...
        case Array:
          ...
          const targetArrayItem = <[]>target[k];
        ...
        default:
          if (sourceItem.clone && sourceItem.cloneTo) {
            // Custom clone.
            const sourceCustomItem = <IClone>sourceItem;
            const targetCustomItem = <IClone>target[k];
            if (targetCustomItem) {
